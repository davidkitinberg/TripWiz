...
**Risk register (Excel):** [12/12-risk-register.xlsx](12/12-risk-register.xlsx)
...
| File | Purpose |
|------|---------|
| [`12/12-risk-register.xlsx`](12/12-risk-register.xlsx) | Excel workbook with 12 project risks, custom Probability and Impact scales, and calculated **Exposure** (חשיפה) |
...
The full register with all 12 rows is in **[12/12-risk-register.xlsx](12/12-risk-register.xlsx)** (sheet *Risk Register*). Scale definitions are on the *Scales* sheet.
...
1. Open [12/12-risk-register.xlsx](12/12-risk-register.xlsx) in Microsoft Excel or Google Sheets.
